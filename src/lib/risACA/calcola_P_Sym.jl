function calcola_P_Sym(m::Vector{Int}, superfici, escalings, id)
    ...
    calculate_P_matrix2(P, x_vs, y_vs, z_vs, xc_s, yc_s, zc_s, a_s, b_s, c_s, sup_s, sup_yz_planes, sup_xz_planes, Float64.(superfici["S"][m]), nsup1, 0, block_size1, id, escalings[:P], epsilon1, epsilon2, epsilon3, epsilon4, use_suppression, eps0)
    return P
end

function calculate_P_matrix2(
