...
# function calcola_P_noSym(m::Vector{Int}, n::Vector{Int}, superfici, escalings, QS_Rcc_FW, id)::Dict{Symbol,Union{Matrix{Float64},Matrix{ComplexF64}}}
#     # @save "inpuP.jld2" superfici escalings QS_Rcc_FW id
#     eps0 = 8.854187816997944e-12
...
#     process_surfaces2!(x_vs, y_vs, z_vs, xc_s, yc_s, zc_s, a_s, b_s, c_s, sup_s, sup_xz_planes, sup_yz_planes, superfici, round_precision, m)
#     process_surfaces2!(x_vs2, y_vs2, z_vs2, xc_s2, yc_s2, zc_s2, a_s2, b_s2, c_s2, sup_s2, sup_xz_planes2, sup_yz_planes2, superfici, round_precision, n)

#     block_size1 = 200  # ad esempio, 10 iterazioni per blocco
#     P = zeros(nsup1, nsup2)

#     calculate_P_matrix_noSym(P, x_vs, y_vs, z_vs, xc_s, yc_s, zc_s, a_s, b_s, c_s, sup_s, sup_yz_planes, sup_xz_planes, Float64.(superfici["S"]), nsup1, x_vs2, y_vs2, z_vs2, xc_s2, yc_s2, zc_s2, a_s2, b_s2, c_s2, sup_s2, sup_yz_planes2, sup_xz_planes2, Float64.(superfici["S"]), nsup2, 0, block_size1, id, escalings[:P], epsilon1, epsilon2, epsilon3, epsilon4, use_suppression, eps0)
#     return Dict(
#         :P => P,
#     )
# end
...
#     S_superfici2::Vector{Float64}, # Pass superfici["S"] directly
#     nsup2::Int,
#     offset::Int, # Added for potential future use with offsets
#     block_size2::Int,
#     id::String,
...
#     for (block_idx, m_block) in enumerate(1:block_size2:nsup1)
#         m_end = min(m_block + block_size2 - 1, nsup1)
...
# function calcola_P_Sym(m::Vector{Int}, superfici, escalings, QS_Rcc_FW, id)::Dict{Symbol,Union{Matrix{Float64},Matrix{ComplexF64}}}
#     # @save "inpuP.jld2" superfici escalings QS_Rcc_FW id
#     eps0 = 8.854187816997944e-12
...
#     calculate_P_matrix(P, x_vs, y_vs, z_vs, xc_s, yc_s, zc_s, a_s, b_s, c_s, sup_s, sup_yz_planes, sup_xz_planes, Float64.(superfici["S"]), nsup1, 0, block_size1, id, escalings[:P], epsilon1, epsilon2, epsilon3, epsilon4, use_suppression, eps0)
#     return Dict(
#         :P => P,
#     )
# end